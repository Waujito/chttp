...
CXX_FLAGS := -Wall -Wextra -Wno-unused-parameter -Wno-sign-compare -Wno-unused-label -pedantic -O0 -g -std=c++23 -D_GNU_SOURCE
CC_FLAGS := -Wall -Wextra -Wno-unused-parameter -Wno-sign-compare -Wno-unused-label -pedantic -O0 -g -std=gnu23 -D_GNU_SOURCE
